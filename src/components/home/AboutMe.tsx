        ...
        <Row>
          <Col xs={12} md={12} lg={6} xl={6} xxl={6} className="about-me__card">
            <div className="coffee-card">
              ...
              <Row>
                <Col xs={12} md={12} lg={12} xl={6} xxl={6} className="about-me__img-wrapper">
          ...
          <Col xs={12} md={12} lg={6} xl={6} xxl={6} className="about-me__text-wrapper">
            <div className="about-me__title-text">Knitting makes me feel happy</div>
            <div className="about-me__text">
              Knitting makes me feel happy Knitting makes me feel happy Knitting makes me feel happy
              Knitting makes me feel happy Knitting makes me feel happy Knitting makes me feel happy
              Knitting makes me feel happy Knitting makes me feel happy Knitting makes me feel happy
              Knitting makes me feel happy Knitting makes me feel happy Knitting makes me feel happy
              Knitting makes me feel happy Knitting makes me feel happy Knitting makes me feel happy
