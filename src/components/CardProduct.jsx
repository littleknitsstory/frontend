      ...
      <div className="card-lks product-card">
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <div className="card-lks__color">Цвет: 
              {props.colors.map(item => <div className="card-lks__color-circle" style={{backgroundColor: item.color}}></div>)}
            </div>
              ...
              <div className="product-card__modal-quick-purchase-body">
                ...
                <div className="product-card__modal-quick-purchase-descr">
                  ...
                  <div className="product-card__modal-quick-purchase-color">
                    Цвет: {props.colors?.map(item => <div className="card-lks__color-div" style={{backgroundColor: item.color}}></div>)}
                  </div>
