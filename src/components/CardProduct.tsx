...
import { addProduct, removeProduct } from "../store/savedProductSlice";
...
const CardProduct = ({ product }: { product: IProduct }) => {
  ...
  const [colorSavedProduct, setColorSavedProduct] = useState<string>("#C7B8A7");
